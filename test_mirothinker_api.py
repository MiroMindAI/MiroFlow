...
async def test_mirothinker_api():
    ...
    llm_config = OmegaConf.create({
        ...
        "base_url": os.getenv("OAI_MIROTHINKER_BASE_URL", "http://localhost:61005/v1"),
        "temperature": 1.0,
        "top_p": 0.95,
        "min_p": 0.0,
        "top_k": -1,
    ...
    try:
        ...
        # Test message
        test_message = "Hello! Please respond with a simple greeting and tell me what 2+2 equals."
