...
# 解析命令行参数
# 用法: bash run_fast_eval.sh [LLM_MODEL] [BASE_URL]
...
bash scripts/qwen3-in-house/run_evaluate_multiple_runs_hle.sh 100

bash scripts/qwen3-in-house/run_evaluate_multiple_runs_browsecomp-subset.sh

bash scripts/qwen3-in-house/run_evaluate_multiple_runs_supergpqa.sh 100
